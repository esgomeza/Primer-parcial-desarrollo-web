/* =========================================================
   SportMax — Web Component: <producto-card>
   Archivo: js/producto-card.js

   Componente web personalizado que encapsula la tarjeta de
   producto usando Shadow DOM. Recibe atributos:
